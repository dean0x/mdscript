...
- `packages/mds/src/util/module-scanner.ts` — `buildModulesMap`, `normalizeVirtualKey`, `PathError`, `realpathParent`, `openNoFollow`, `readError`, `closeModule`, `assertKeyMatchesDisk` (WASM-backend file pre-scanner)
