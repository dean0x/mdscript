...
mds lint --quiet .              # directory lint: silent on clean/warn-only; summary prints on errors
```
...
unexplained. The JSON stdout envelope is unchanged in directory mode (no `"summary"` key added).
