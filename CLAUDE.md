...
- Local WASM builds (`npm run build -w @mdscript/mds-wasm`) require Binaryen for wasm-opt — install via `brew install binaryen` (macOS) or `apt install binaryen` (Linux)
